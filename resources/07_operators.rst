...
+----------+-------+-----+-----------------------------------------------------+
| ==       | ``[[``| B   | equal to, double-bracket, pattern matching          |
+----------+-------+-----+-----------------------------------------------------+
| !=       | ``[`` | B   | not equal to, within test, whitespace req'd         |
+----------+-------+-----+-----------------------------------------------------+
| !=       | ``[[``| B   | not equal to, double-bracket, pattern matching      |
+----------+-------+-----+-----------------------------------------------------+
| =~       | ``[[``| B   | matches, double-bracket, regex on right             |
+----------+-------+-----+-----------------------------------------------------+
| <        | all   | B   | less than, ASCII order, escape req'd in ``[``       |
+----------+-------+-----+-----------------------------------------------------+
| >        | all   | B   | greater than, ASCII order, escape req'd in ``[``    |
+----------+-------+-----+-----------------------------------------------------+
...
+----------+-------+-----+-----------------------------------------------------+
| !        |  all  |  U  | "not" -- reverses the sense of the tests above      |
+----------+-------+-----+-----------------------------------------------------+
